...
std::shared_ptr<AudioFile> AudioFileAnalyzer::Analyze(std::string file_path)
{
...
/*----------------------------------------------------------AudioFileAnalyzer AnalyzeOGG()--------------------------------------------*/

std::shared_ptr<AudioFile> AudioFileAnalyzer::AnalyzeOGG(std::string file_path)
{
...
/*----------------------------------------------------------AudioFileAnalyzer AnalyzeWAV()--------------------------------------------*/

std::shared_ptr<AudioFile> AudioFileAnalyzer::AnalyzeWAV(std::string file_path)
{
